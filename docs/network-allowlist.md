...
| `stt-rt.soniox.com`, `stt-rt.eu.soniox.com`, `stt-rt.jp.soniox.com`, `stt-rt.in.soniox.com` | WSS        | 443  | Soniox API key configured. Realtime-only, dictation only (no file-upload, retry, or note-recording path): the region setting picks the US, EU, Japan, or India host.                                                                                                                                                                                     |
| `api.soniox.com`                                                                            | HTTPS      | 443  | Soniox API key configured. Credential check when the key is tested in Settings or onboarding (`/v1/models`).                                                                                                                                                                                                                                             |
