...
| `stt-rt.soniox.com`, `stt-rt.eu.soniox.com`                                      | WSS        | 443  | Soniox API key configured. Realtime-only, dictation only (no file-upload, retry, or note-recording path): the region setting picks the US or EU host.                                                                                                                                                                                                    |
